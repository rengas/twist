...
<template>
  <Teleport to="body">
    <div v-if="modelValue"
         class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-6 bg-black/60 backdrop-blur-sm"
         @click.self="cancel"
         @keydown="onKeydown"
         tabindex="-1">
      <div class="w-full sm:max-w-lg rounded-t-2xl sm:rounded-2xl bg-slate-800 border border-slate-700/60 shadow-2xl shadow-black/50 max-h-[90vh] sm:max-h-none overflow-y-auto"
        ...
        <!-- Body -->
        <div class="px-4 sm:px-6 py-4 sm:py-5 space-y-5 sm:space-y-6">
